...
## A systems-level approach to human speech neuroscience {visibility="uncounted"}
...
## First steps: Linguistics and Cognitive Science Undergraduate at UC Berkeley
![](images/Sitek_academic-bio/Slide1.png){fig-align="center" height='900'}
...
::: aside
Sitek et al. (2016). "Auditory cortex processes variation in our own speech". 
:::
...
::: aside
Sitek* and Gulban* et al. (2019). "Mapping the human subcortical auditory system". 
:::
...
::: aside
Ultra-high field functional MRI of the human midbrain 
:::
...
::: aside
K01 (2022–2027); Sitek et al. (2022) "Structural connectivity of human inferior colliculus subdivisions..." 
:::
...
::: aside
R21 (2025–2028); Sitek et al. (in re-review); Butler, ..., Sitek (in prep.) 
:::
...
- Function (Sitek & Gulban et al., 2019; Medina, Sitek, et al., in review)
...
- Auditory categorization in the human brain (Sitek et al., in re-review)
- Developing speech-in-noise processes (Sitek et al., SNL 2025)
:::
::::
...
![](images/Sitek2025_categorization/Sitek_Fig2_spect.png){fig-align="center" height="700" .fragment}

![](images/Sitek2025_categorization/Sitek_Fig2_exp.png){fig-align="center" height="700" .fragment}
...
#### Dynamics of learning and categorization in dorsal striatum {.fragment}
#### When presented with **feedback**: {.fragment}
...
## Auditory feedback processing in animals
...
## Hearing out own speech: *Where* are motor signals integrated in auditory cortex?
...
- But fMRI has shown *increased* BOLD to self-generated sounds, vs. *suppressed* M/EEG responses
...
![Reznik et al. (2015)](images/Reznik2014_Figure1a.png){fig-align="center" height="250"}
...
## Hearing out own speech: *Where* are motor signals integrated in auditory cortex? {visibility="uncounted"}
...
- Future work: Pinpointing feedback dysfunction in *stuttering* *apraxia*, and *schizophrenia*
:::
:::
...
::: aside
Medina et al. (submitted preprint)
...
## Enhancing clinical precision with stronger human neuroscience
...
## Greater self-generated vs. passive fMRI responses in a single participant across replications {visibility="hidden"}
...
## Stronger self-generated (vs. passive) sound responses in superficial auditory cortex {visibility="hidden"}
